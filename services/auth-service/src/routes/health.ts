...
const healthRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get('/status', {
    schema: {
      ...
      description: 'Returns the current health status of the authentication service and its dependencies',
      response: {
        200: {
          type: 'object',
          properties: {
            ...
            checks: {
              ...
              properties: {
                ...
                cpu: { $ref: '#/components/schemas/HealthCheck' },
              },
            },
          },
        },
    ...
    try {
      ...
      const [databaseCheck, redisCheck, memoryCheck, cpuCheck] = await Promise.allSettled([
        checkDatabase(),
        checkRedis(),
        checkMemory(),
        checkCPU(),
